...
export default function SettingsPage() {
  ...
  const validateSettings = (
    settingsToValidate: UserSettings
  ): Record<string, string> => {
  ...
  const handleExportData = async () => {
    try {
      ...
      if (response.ok) {
        ...
        a.href = url;
        a.download = `vibed-to-cracked-data-${
                              ...
                              <div className="flex items-center justify-between text-xs">
                                ...
                                >
                                  {mood.quizSettings.difficulty
                                    .charAt(0)
                                    .toUpperCase() +
                                    mood.quizSettings.difficulty.slice(1)}
                                </span>
                              </div>
                        ...
                        <div className="mt-6 p-4 bg-gradient-to-r from-blue-50 to-indigo-50 dark:from-blue-900/20 dark:to-indigo-900/20 rounded-lg border border-blue-200 dark:border-blue-800">
                          <h4 className="font-medium text-gray-900 dark:text-gray-100 mb-2 flex items-center gap-2">
                            <span className="text-xl">
                              {MOODS[settings.preferredMood].emoji}
                            </span>
                          ...
                          <div className="text-sm text-gray-600 dark:text-gray-400 space-y-1">
                            <p>
                              ...
                              <strong>
                                {
                                  MOODS[settings.preferredMood].quizSettings
                                    .questionsPerTutorial
                                }{" "}
                                questions per quiz
                              </strong>{" "}
                              at{" "}
                            ...
                            <p>
                              •{" "}
                              {MOODS[settings.preferredMood].features.animations
                                ? "Enhanced with smooth animations and effects"
                                : "Clean, distraction-free interface for maximum focus"}
                            </p>
                          </div>
                        </div>
                      )}
                    ...
                    {settings.notifications.reminders && (
                      <div className="bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-lg p-4">
                        ...
                        <p className="text-blue-700 dark:text-blue-300 text-sm">
                          You&apos;ll receive daily study reminders at{" "}
                          {settings.learning.reminderTime} in your local
                          timezone. Reminders will include your current progress
