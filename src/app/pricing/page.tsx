  ...
  const getPlansWithDynamicPricing = (): PricingPlan[] => [
    {
      ...
      price: 0,
      period: "forever",
      description: "Start your journey and build your first 3 projects 🌊",
      emoji: "🎯",
      features: [
        { text: "15 Beginner Tutorials", included: true, highlight: true },
        {
          text: "Unlimited Practice Challenges",
          included: true,
          highlight: true,
        },
    ...
    },
    {
      ...
      period: "month",
      description:
        "Build a job-ready portfolio and master full-stack development 🚀",
      popular: true,
      emoji: "🔥",
      features: [
        {
          text: "Build 10+ Portfolio Projects",
          included: true,
          highlight: true,
        },
        {
          text: "Master JavaScript, HTML & CSS",
          included: true,
          highlight: true,
        },
        ...
        { text: "AI Mock Interviews (preview only)", included: true },
        { text: "1-on-1 Code Reviews (4/month)", included: false },
    ...
    },
    {
      ...
      features: [
        ...
        {
          text: "Interview Prep & Resume Review",
          included: true,
          highlight: true,
        },
        ...
        {
          text: "5 AI Mock Interview Credits/month",
          included: true,
          highlight: true,
        },
      ],
        ...
        <div className="mb-8 mx-auto max-w-2xl">
          <div className="bg-linear-to-r from-orange-500 to-red-500 text-white px-6 py-3 rounded-lg shadow-lg text-center">
            ...
            <div className="text-sm mt-1">
              Lock in this price forever. Prices increase as we add more
              features.
            </div>
          </div>
        </div>
            ...
            <div className="p-8">
              ...
              <div className="text-center mb-6">
                ...
                {isAnnual && plan.id !== "FREE" && (
                  <div className="text-sm text-green-600 dark:text-green-400">
                    Save $
                    {(
                      getRealPrice(plan.id as "VIBED" | "CRACKED", false) * 12 -
              ...
              {plan.id === "VIBED" && (
                <p className="text-center text-xs text-gray-500 dark:text-gray-400 mt-2">
                  7-day free trial • 30-day money-back guarantee • Cancel
                  anytime
                </p>
              )}
              {plan.id === "CRACKED" && (
      ...
      <div className="mt-16 max-w-3xl mx-auto">
        <div className="bg-linear-to-r from-purple-100 to-pink-100 dark:from-purple-900/20 dark:to-pink-900/20 rounded-2xl p-8 text-center border border-purple-200 dark:border-purple-800">
          ...
          <p className="text-gray-600 dark:text-gray-300 mb-6">
            ...
            education, regardless of financial situation. If you&apos;re facing
            financial hardship, you can request free access to our premium
            features.
          </p>
          <Link
            href="/free-access"
        ...
        <div className="space-y-8">
          <div className="bg-white dark:bg-gray-800 rounded-lg p-6 shadow-lg">
            ...
            <p className="text-gray-600 dark:text-gray-400">
              ...
              subscription at any time. Changes take effect at the next billing
              cycle. No stress!
            </p>
          </div>
          <div className="bg-white dark:bg-gray-800 rounded-lg p-6 shadow-lg">
            ...
            <p className="text-gray-600 dark:text-gray-400">
              The 7-day free trial gives you full access to all Vibed features.
              No credit card required to start - just pure learning vibes!
            </p>
          </div>
          <div className="bg-white dark:bg-gray-800 rounded-lg p-6 shadow-lg border-2 border-orange-200 dark:border-orange-800">
            ...
            <p className="text-gray-600 dark:text-gray-400">
              Yes! We&apos;re currently offering early adopter pricing. As we
              add more features and content, prices will increase. Lock in your
              price now and keep it forever - even as we raise prices for new
              members.
            </p>
          </div>
          <div className="bg-white dark:bg-gray-800 rounded-lg p-6 shadow-lg">
