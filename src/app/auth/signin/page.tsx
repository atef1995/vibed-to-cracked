...
function SignInContent() {
  ...
  if (status === "authenticated") {
    return (
      <div className="min-h-screen bg-linear-to-br from-blue-50 dark:from-blue-500 via-indigo-50 dark:via-indigo-500 to-purple-50 dark:to-purple-500 flex items-center justify-center">
