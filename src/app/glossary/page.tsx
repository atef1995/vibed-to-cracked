      ...
      <div className="max-w-5xl mx-auto">
        <header className="mb-12">
          ...
          <p className="text-lg text-gray-600 dark:text-gray-400 max-w-2xl">
            ...
            TypeScript, data structures, and web development. Each term includes
            a clear definition and code example.
          </p>
        </header>
        ...
        <nav
          ...
          className="flex flex-wrap items-center justify-center gap-1 mb-10 sticky top-0 bg-white/90 dark:bg-transparent/5 backdrop-blur py-3 z-10 border-b border-gray-200 dark:border-gray-800"
        >
          {letters.map((letter) => (
            <a
              key={letter}
