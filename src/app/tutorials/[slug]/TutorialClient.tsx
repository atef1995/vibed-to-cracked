...
export default function TutorialClient({ slug }: TutorialClientProps) {
  ...
  const createHeadingComponent = (level: 1 | 2 | 3 | 4) => {
    const HeadingComponent = (props: React.HTMLAttributes<HTMLHeadingElement>) => {
      ...
      switch (level) {
        case 1:
          return <h1 {...headingProps}>{props.children}{anchorLink}</h1>;
        case 2:
          return <h2 {...headingProps}>{props.children}{anchorLink}</h2>;
        case 3:
          return <h3 {...headingProps}>{props.children}{anchorLink}</h3>;
        case 4:
          return <h4 {...headingProps}>{props.children}{anchorLink}</h4>;
        default:
          return <h2 {...headingProps}>{props.children}{anchorLink}</h2>;
      }
    };
