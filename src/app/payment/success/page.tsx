      ...
      <div className="container mx-auto px-4 py-12">
        <div className="max-w-2xl mx-auto text-center">
          ...
          <p className="text-xl text-gray-600 dark:text-gray-300 mb-8">
            {currentMood.id === "rush" &&
              "Time to dominate JavaScript like a total legend! 🔥"}
            {currentMood.id === "grind" &&
              "Your serious learning journey begins now."}
            {currentMood.id === "chill" &&
              "Take your time and enjoy the premium experience! 😊"}
          </p>
          ...
          <div className="mt-12 text-center">
            <p className="text-gray-600 dark:text-gray-400 text-sm">
              ...
              <a
                ...
                className={`${moodColors.accent} hover:underline`}
              >
                Contact Support
              </a>
            </p>
