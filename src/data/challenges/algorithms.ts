...
export const algorithmChallenges: Challenge[] = [
  {
    ...
    moodAdapted: {
      ...
      chill:
        "A beautiful mathematical sequence. Take your time to understand the pattern. 🌸",
      grind:
        "Practice recursive thinking and optimization techniques. Consider both recursive and iterative approaches.",
    },
  ...
  },
  {
    ...
    moodAdapted: {
      ...
      chill:
        "Think through the problem step by step. There's an elegant solution waiting. 🍃",
      grind:
        "Practice hash map optimization. Study time complexity trade-offs between brute force and optimized approaches.",
    },
