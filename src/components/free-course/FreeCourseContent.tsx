    ...
    <div className="container mx-auto px-4 py-16 max-w-4xl">
      ...
      <div className="text-center mb-12 animate-fade-in-up">
        ...
        <p className="text-xl text-gray-600 dark:text-gray-400 mb-8">
          Get our <strong>free email course</strong> that teaches you the
          JavaScript fundamentals you need to start building real projects —
      ...
      {/* What You'll Learn */}
      <div
        className="bg-white dark:bg-gray-800 rounded-2xl p-8 mb-12 shadow-xl animate-fade-in-up"
      ...
      >
        ...
        <div className="grid md:grid-cols-5 gap-4">
          {COURSE_DAYS.map((item, idx) => (
            <div
              key={item.day}
              className="text-center p-4 border border-gray-200 dark:border-gray-700 rounded-lg hover:border-blue-500 dark:hover:border-blue-400 transition-colors animate-fade-in-up"
      ...
      {/* Email Form / Success States */}
      {submitted ? (
        <div className="bg-green-50 dark:bg-green-900/20 border-2 border-green-500 rounded-2xl p-8 mb-12 text-center animate-fade-in">
          ...
          <p className="text-gray-600 dark:text-gray-400 mb-4">
            We&apos;ve sent Day 1 of your free JavaScript course. Check your
            inbox (and spam folder) now!
          </p>
          <Link
            href="/tutorials"
        ...
        <div className="bg-blue-50 dark:bg-blue-900/20 border-2 border-blue-500 rounded-2xl p-8 mb-12 text-center animate-fade-in">
          ...
          <p className="text-gray-600 dark:text-gray-400 mb-4">
            Check your inbox for the course emails. While you wait, browse our
            tutorials below.
          </p>
          <Link
            href="/tutorials"
        ...
        <div
          className="bg-linear-to-r from-blue-600 to-purple-600 rounded-2xl p-8 mb-12 shadow-xl animate-fade-in-up"
          ...
          <form onSubmit={handleSubmit} className="max-w-md mx-auto">
            <div className="flex flex-col sm:flex-row gap-3">
              ...
              <button
                type="submit"
                disabled={loading}
                className="min-w-36 flex items-center justify-center bg-white text-blue-600 px-6 py-3 rounded-lg font-semibold hover:bg-gray-100 transition-colors disabled:opacity-50 disabled:cursor-not-allowed whitespace-nowrap"
              >
                {loading ? "Subscribing..." : "Get Free Course"}
              </button>
            </div>
            {/* Reserved space for error to prevent layout shift */}
            <p className="text-red-200 text-sm mt-2 text-center h-5">
