...
export function PlaybackControls({
  ...
  return (
    <div className="bg-gray-50 dark:bg-gray-800 border-t border-gray-200 dark:border-gray-700 px-4 py-3">
      ...
      <div className="mb-3">
        <div
          className="h-2 bg-gray-200 dark:bg-gray-700 rounded-full cursor-pointer hover:h-3 transition-all"
      ...
      <div className="flex items-center justify-center gap-2">
        ...
        <button
          onClick={onReset}
          disabled={disabled}
          className="p-2 rounded-lg hover:bg-gray-200 dark:hover:bg-gray-700 text-gray-700 dark:text-gray-300 disabled:opacity-50 disabled:cursor-not-allowed transition-colors"
        ...
        <button
          ...
          disabled={disabled}
          className="p-3 rounded-lg bg-blue-500 hover:bg-blue-600 dark:bg-blue-600 dark:hover:bg-blue-700 text-white disabled:opacity-50 disabled:cursor-not-allowed transition-colors shadow-md"
