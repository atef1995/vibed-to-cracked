    ...
    try {
      ...
      if (response.ok) {
        ...
        setStats({
          ...
          emailsSent:
            data.results?.filter((r: EmailResult) => r.success).length || 0,
        });
      } else {
            ...
            <div className="border border-gray-300 rounded-md p-4 bg-gray-50">
              <div className="bg-white rounded-md p-4 shadow-sm">
                ...
                <div className="p-4">
                  ...
                  <p className="mb-4">
                    {promotion.description ||
                      "Your promotional description will appear here..."}
                  </p>
                  <div className="bg-yellow-50 p-3 border-l-4 border-yellow-400 mb-4">
                    <strong>
                      🎯 This offer is personalized for your [User Mood]
                      learning style!
                    </strong>
                  </div>
                  <p className="mb-4">
                    Don&rsquo;t miss out on this opportunity to level up your
                    programming skills with premium content and features.
                  </p>
                  ...
                  <p className="text-sm text-gray-500 mt-4">
                    This offer expires soon. Take action now! ⏰
                  </p>
                </div>
              </div>
            </div>
