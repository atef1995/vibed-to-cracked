...
export default function BroadcastEmailForm({
  ...
  return (
    <div className="p-6">
      <div className="mb-6">
        <h2 className="text-2xl font-bold text-gray-400">Broadcast Email</h2>
      ...
      {result && (
        <div
          className={`mb-6 p-4 rounded-lg ${
            result.success
              ? "bg-gray-600 border border-green-200"
              : "bg-gray-600 border border-red-200"
          }`}
        >
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div>
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            >
              ...
              <div className="text-sm text-gray-400">Send to everyone</div>
            </button>
            ...
            >
              ...
              <div className="text-sm text-gray-400">Free plan only</div>
            </button>
            ...
            >
              ...
              <div className="text-sm text-gray-400">Paid subscribers</div>
            </button>
            ...
            >
              ...
              <div className="text-sm text-gray-400">Custom list</div>
            </button>
          </div>
        </div>
        ...
        <div>
          ...
          <p className="text-sm text-gray-400 mt-2">
            💡 Tip: You can use HTML formatting. Variables: {"{username}"},{" "}
            {"{email}"}
          </p>
        </div>
        ...
        <div className="bg-gray-6000 border border-gray-600 rounded-lg p-4">
          <h3 className="font-medium text-gray-400 mb-2">Preview</h3>
          <div className="bg-gray-700 p-4 border rounded">
            ...
            <div
              ...
              dangerouslySetInnerHTML={{
                __html:
                  message || "<em>Message preview will appear here...</em>",
              }}
            />
            {includeUnsubscribe && (
