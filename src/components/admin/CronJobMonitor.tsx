  ...
  return (
    <div className="p-6">
      <div className="flex justify-between items-center mb-6">
        <div>
          ...
          <p className="text-gray-400">
            Automated study reminder system status
          </p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
        <div
          className={`bg-${statusColor}-600 border border-${statusColor}-700 rounded-lg p-6`}
        >
          <div className="flex items-center">
            ...
            <div>
              <div className={`text-2xl font-bold text-${statusColor}-100`}>
                {statistics.successRate}%
              </div>
              <div className={`text-sm text-${statusColor}-100`}>
                Success Rate
              </div>
            </div>
          </div>
        ...
        <div className="bg-gray-600 border border-blue-200 rounded-lg p-6">
          <div className="flex items-center">
        ...
        <div className="bg-gray-600 border border-purple-200 rounded-lg p-6">
          <div className="flex items-center">
            <div className="text-3xl mr-4">📧</div>
            <div>
        ...
        <div className="bg-gray-600 border border-orange-200 rounded-lg p-6">
          <div className="flex items-center">
            <div className="text-3xl mr-4"></div>
            <div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          {lastExecution ? (
            <div className="space-y-3">
              <div className="flex justify-between">
                ...
                <span
                  className={`font-medium ${lastExecution.success ? "text-green-600" : "text-red-600"}`}
                >
              ...
              <div className="flex justify-between">
                ...
                <span className="font-medium">
                  {lastExecution.timeSpent || 0}s
                </span>
              </div>
              {lastExecution.result && (
                <div>
                  <span className="text-gray-400">Result:</span>
                  <p className="text-sm bg-gray-700 p-2 rounded mt-1 font-mono">
                    {lastExecution.result}
                  </p>
                </div>
              )}
              {lastExecution.error && (
                <div>
                  ...
                  <p className="text-sm bg-gray-600 p-2 rounded mt-1 font-mono text-red-700">
                    {lastExecution.error}
                  </p>
                </div>
              )}
        ...
        <div className="bg-gray-700 border border-gray-600 rounded-lg p-6">
          ...
          <div className="space-y-4">
            <div className="flex items-center justify-between">
              <span className="text-gray-400">Cron Job Status</span>
              <div className="flex items-center">
                <div
                  className={`w-3 h-3 rounded-full bg-${statusColor}-500 mr-2`}
                ></div>
            ...
            <div className="flex items-center justify-between">
              <span className="text-gray-400">Recent Success Rate</span>
            ...
            <div className="flex items-center justify-between">
              ...
              <span
                className={`font-medium ${statistics.failedJobs > 0 ? "text-red-600" : "text-green-600"}`}
              >
            ...
            {statistics.successRate < 90 && (
              <div className="bg-yellow-500 border border-yellow-400 rounded p-3 mt-4">
        ...
        <div className="bg-gray-700 border border-gray-600 rounded-lg p-6 lg:col-span-2">
          <h3 className="text-lg font-medium text-gray-900 mb-4">
            Recent Executions
          </h3>
      ...
      {/* Setup Instructions */}
      <div className="mt-8 bg-gray-600 border border-blue-200 rounded-lg p-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div>
            ...
            <div className="text-sm text-gray-400space-y-1">
              <p>
                1. Run as Administrator:{" "}
                <code className="bg-gray-400 px-2 py-1 rounded">
          ...
          <div>
            <h4 className="font-medium text-gray-400 mb-2">Manual Testing</h4>
            <div className="text-sm text-gray-400space-y-1">
              <p>
                Test:{" "}
                <code className="bg-gray-400 px-2 py-1 rounded">
