...
export default function StudyReminderForm() {
  ...
  const fetchStats = useCallback(async () => {
    try {
      const response = await fetch(
        `/api/email/study-reminder?days=${daysInactive}`
      );
      if (response.ok) {
  ...
  const setupAutoSchedule = async () => {
    ...
    alert(
      "Auto-scheduling feature would be implemented with a background job service (like cron or AWS Lambda)"
    );
  };
    ...
    <div className="p-6">
      <div className="mb-6">
        ...
        <p className="text-gray-400">
          Send automated reminders to inactive users with their progress
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        ...
        <div className="space-y-6">
          <div className="bg-gray-600 border border-blue-200 rounded-lg p-4">
          ...
          <div>
            ...
            <p className="text-sm text-gray-500 mt-1">
              Users who haven&rsquo;t been active for this many days will
              receive reminders
            </p>
          </div>

          {stats && (
            <div className="bg-gray-6000 border border-gray-600 rounded-lg p-4">
              ...
              <div className="grid grid-cols-1 gap-3">
                <div className="flex justify-between">
                  <span className="text-gray-400">
                    Inactive users ({daysInactive}+ days):
                  </span>
                ...
                <div className="flex justify-between">
                  ...
                  <span className="font-semibold text-green-600">
                    {stats.usersWithRemindersEnabled}
                  </span>
                </div>
                <div className="flex justify-between">
                  <span className="text-gray-400">Eligible for reminders:</span>
          ...
          <div className="space-y-3">
            ...
            {autoSchedule && (
              <p className="text-xs text-gray-500 ml-6">
                Reminders will be sent automatically every day at 6 PM local
                time to eligible users
              </p>
            )}
          </div>
          ...
          <div className="flex space-x-4">
            ...
            >
              {isLoading
                ? "Sending..."
                : `Send to ${stats?.inactiveUsersCount || 0} Users`}
            </button>
          </div>
        ...
        <div className="space-y-6">
          <div>
            ...
            <div className="border border-gray-300 rounded-md p-4 bg-gray-6000">
              <div className="bg-gray-700 rounded-md p-4 shadow-sm">
                <div className="bg-linear-to-r from-blue-400 to-cyan-400 text-white p-4 rounded-t-md">
                  ...
                  <p className="text-sm opacity-90">
                    Time to get back in the chill zone
                  </p>
                </div>
                <div className="p-4">
                  <p className="mb-4">Hey [User Name]! 👋</p>
                  <p className="mb-4">
                    We noticed it&rsquo;s been {daysInactive} day
                    {daysInactive > 1 ? "s" : ""} since your last coding
                    session. Your JavaScript skills are missing you!
                  </p>

                  <div className="bg-gray-600 p-3 rounded-lg mb-4 text-center">
                    <h3 className="font-bold text-green-800">
                      🔥 Your Current Progress:
                    </h3>
                    <div className="mt-2 space-y-1 text-sm text-green-700">
                      <p>
                        • <strong>In Progress:</strong> JavaScript Arrays
                        Tutorial
                      </p>
                      <p>
                        • <strong>Next Challenge:</strong> Array Methods
                        Practice
                      </p>
                      <p>
                        • <strong>Current Streak:</strong> 5 days
                      </p>
                      <p>
                        • <strong>Completion:</strong> 65% through JavaScript
                        Fundamentals
                      </p>
                    </div>
                  </div>
                  ...
                  <p className="mb-4">
                    Remember, consistency is key to mastering JavaScript. Even
                    15 minutes of practice can make a huge difference!
                  </p>
                  ...
                  <ul className="text-sm mb-4 space-y-1">
                    <li>
                      🎯 Complete &ldquo;JavaScript Arrays&rdquo; tutorial (10
                      mins)
                    </li>
                    <li>
                      💪 Try the &ldquo;Array Methods&rdquo; challenge (15 mins)
                    </li>
                  ...
                  <a
                    href="#"
                    className="inline-block bg-gray-6000 text-white px-6 py-3 rounded-full font-semibold"
                  >
                    Continue Learning
                  </a>
          ...
          {results.length > 0 && (
            <div>
              ...
              <div className="bg-gray-600 border border-orange-200 rounded-md p-4 mb-4">
                <div className="grid grid-cols-2 gap-4 text-center">
                  <div>
                    <div className="text-2xl font-bold text-orange-600">
                      {results.filter((r) => r.success).length}
                    </div>
                    <div className="text-sm text-gray-400">Reminders Sent</div>
                  </div>
                  <div>
              ...
              <div className="max-h-64 overflow-y-auto border border-gray-300 rounded-md">
                {results.map((result, index) => (
                  <div
                    key={index}
                    className={`p-3 border-b ${result.success ? "bg-gray-600" : "bg-gray-600"}`}
                  >
